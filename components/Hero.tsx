export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(220,192,138,0.16),transparent_32%),linear-gradient(180deg,#000,#080808)] pt-[6.5rem] pb-16 text-white sm:pb-20">
      ...
      <div className="mx-auto flex min-h-[calc(100vh-6.5rem)] max-w-screen-xl flex-col justify-center px-4 sm:px-6">
        ...
        <h1 className="text-4xl font-black leading-tight text-white sm:text-5xl md:text-6xl xl:text-7xl">
          PUENTE QUINTO
        </h1>
