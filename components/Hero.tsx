export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(220,192,138,0.16),transparent_32%),linear-gradient(180deg,#000,#080808)] pb-24 pt-[5.5rem] text-white">
      ...
      <div className="mx-auto flex min-h-[calc(100vh-5.5rem)] max-w-6xl flex-col justify-center px-6">
        ...
        <p className="mt-6 max-w-3xl text-lg text-zinc-300 sm:text-xl">
          Un viaje sonoro intenso con grooves profundos, melodías emotivas y un estilo único que pisa fuerte.
        </p>
